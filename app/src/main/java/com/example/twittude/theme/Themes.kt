package com.example.twittude.theme
...
private val TwittudeDarkPalette = darkColors(
    primary = Blue200,
...
private val TwittudeLightPalette = lightColors(
    primary = Blue500,
...
fun TwittudeTheme(
    ...
    val myColors = colors ?: if (isDarkTheme) TwittudeDarkPalette else TwittudeLightPalette

    MaterialTheme(
        colors = myColors,
        content = content,
        typography = TwittudeTypography,
        shapes = TwittudeShapes
    )
}